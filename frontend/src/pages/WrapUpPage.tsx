        ...
        <>
          ...
          <CoachNote
            ...
            onAct={(rec) => {
              ...
              navigate(
                rec.action === 'drill'
                  // `rec` rides along so the rehearsal can report back that
                  // this advice was taken. Without it the agent asks "did she do
                  // what I said" every run and is told no every time.
