...
cluster, a Supabase project with email auth enabled, and an AWS account. Then
`npm install`, copy the two `.env.example` files, `npm run db:migrate`,
`npm run import:play`, `npm run dev`.
